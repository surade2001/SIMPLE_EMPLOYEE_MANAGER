...
ResultSet rs;
    ...
    public void jTable1(){
        try{
        String sql = "select Department, ID, Date, Time, Month, Year, Status from `attendence` where ID=? and Month=? and Year=?";
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(876, 501));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSpecificly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
